...
% Simulation =  'edited_lineargradient';
% Simulation = 'edited_exponentialgradient';
% Simulation = 'PNJctEqBias';
...
elseif strcmp(Simulation,'GaussianTwoCarRC')
 ...
 elseif strcmp(Simulation,'edited_lineargradient')
    eval('edited_lineargradient');   
 elseif strcmp(Simulation,'edited_exponentialgradient')
    eval('edited_exponentialgradient');  
